...
// Заправка (шаг 3): кончик уходит ЗА столб (TUCK3_BACK — слой back), выныривает слева и
// идёт вверх-вправо, ПЕРЕСЕКАЯ диагональ DA и ныряя ПОД неё; кончик торчит за DA (front).
const TUCK3_BACK = 'M245,440 L165,420';
const TUCK3_FRONT = 'M165,420 L230,386';
